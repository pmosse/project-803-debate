...
import { LayoutDashboard, Mic, PlusCircle, Users, DollarSign, HelpCircle, Eye } from "lucide-react";
...
const NAV_LINKS = [
  ...
  { href: "/professor/assignments/new", label: "New Assignment", icon: "plus" },
] as const;
